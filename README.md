...
This application shows how you can use cloud call with the RHMAP platform, it should be used in combination with the [Welcome cloud app](https://github.com/feedhenry-templates/welcome-cloud). Refer to [fhconfig.json](www/fhconfig.json) for configuration.
